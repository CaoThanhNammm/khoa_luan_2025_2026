...
4. Chỉ trả lời, không giải thích thêm, diễn đạt tự nhiên theo ngôn ngữ tiếng việt
### Câu hỏi: {question}
### Tài liệu: {references}
"""
...
4. Bỏ đi các "step" dư thừa
Hãy trả lời theo cách tự nhiên nhất để người đọc dễ hiểu, phải sử dụng hoàn toàn tiếng việt
Câu hỏi: {question}
Câu trả lời: {answer}
"""
