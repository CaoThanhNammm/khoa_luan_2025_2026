...
if __name__ == "__main__":
    qa = pd.read_csv(r'D:\dataset_benchmark_khoa_luan\prime\prime_auto_qa.csv')
    ...
    for index, row in qa[275:].iterrows():
        ...
        try:
            ...
            answer = conversation.answer_prime()
    ...
    my_qa.to_csv(fr"C:\Users\Nam\Desktop\my_qa_prime_final.csv", encoding='utf-8-sig')
