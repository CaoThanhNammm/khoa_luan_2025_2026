...
if __name__ == "__main__":
    ...
    # 2. câu hỏi
    question = [
    "Tỷ lệ tham dự tối thiểu cho học phần thực hành để thi là bao nhiêu?",
    "Sinh viên phải dự bao nhiêu phần trăm giờ thực hành để được thi?",
    "Điều kiện tham dự giờ thực hành để được thi là bao nhiêu phần trăm?",
    "Sinh viên được thi kết thúc học phần bao nhiêu lần?",
    "Trường tổ chức kỳ thi kết thúc học phần với tần suất thế nào?",
    "Khi nào sinh viên được biết hình thức thi kết thúc học phần?",
    "Giảng viên phải thông báo hình thức thi hết học phần vào lúc nào?",
    "Lúc nào sinh viên sẽ được thông tin về hình thức thi?",
    "Trọng số tối thiểu của điểm thi kết thúc học phần là bao nhiêu?",
    "Thi hết học phần bắt buộc có trọng số tối thiểu là?",
