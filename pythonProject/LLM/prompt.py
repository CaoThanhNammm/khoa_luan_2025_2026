...
ví dụ 1: Trường Đại học Nông Lâm TP.HCM trực thuộc cơ quan nào?
{{
  "entities": [
    {{
      "entity": "Trường Đại học Nông Lâm TP.HCM",
      "type": "tổ chức"
    }},
    {{
      "entity": "cơ quan",
...
ví dụ 2: Diện tích khuôn viên Trường Nông Lâm là bao nhiêu?
...
{{
  ...
  "relations":[
    {{
      "source" : "Trường Đại học Nông Lâm TP.HCM",
      "target" : "Diện tích khuôn viên",
      "relation" : "có"
    }}
  ]
}}
ví dụ 3: Trường Nông Lâm đã tồn tại trong bao nhiêu năm?
...
{{
  "entities": [
    ...
    {{
      "entity": "Đại học Nông Lâm TP.HCM",
      "type": "tổ chức"
    }},
    {{
      "entity": "số lượng",
  ...
  "relations":[
    {{
      "source" : "Ký túc xá",
      "target" : "Đại học Nông Lâm TP.HCM",
      "relation" : "tại"
    }},
    {{
...
{{
  "entities": [
    {{
      "entity": "ngành đào tạo",
      "type": "chương trình học"
    }},
    {{
      "entity": "Khoa Chăn nuôi - Thú y",
      "type": "khoa"
    }},
    {{
      "entity": "Đại học Nông Lâm TP.HCM",
  ...
  "relations":[
    {{
      "source" : "ngành đào tạo",
      "target" : "Khoa Chăn nuôi - Thú y",
      "relation" : "thuộc_khoa"
    }},
    {{
      "source" : "Khoa Chăn nuôi - Thú y",
      "target" : "Đại học Nông Lâm TP.HCM",
      "relation" : "của"
    }},
     {{
...
{{
  "entities": [
    ...
    {{
      "entity": "sinh hoạt công dân - sinh viên",
      "type": "hoạt động"
    }},
    {{
      "entity": "Trường Đại học Nông Lâm TP.HCM",
  ...
  "relations":[
    ...
    {{
      "source" : "thông tin",
      "target" : "sinh hoạt công dân - sinh viên",
      "relation" : "về"
    }},
    {{
      "source" : "sinh hoạt công dân - sinh viên",
...
{{
  "entities": [
    {{
      "entity": "Chiến dịch tình nguyện mùa hè xanh",
      "type": "hoạt động"
    }},
    {{
      "entity": "Trường Đại học Nông Lâm TP.HCM",
  ...
  "relations":[
    {{
      "source" : "Chiến dịch tình nguyện mùa hè xanh",
      "target" : "Trường Đại học Nông Lâm TP.HCM",
      "relation" : "tại"
    }},
    {{
...
{{
  "entities": [
    {{
      "entity": "BEC English Club",
      "type": "ví dụ lạc bộ (clb) - đội, nhóm"
    }},
     {{
      "entity": "Trường Đại học Nông Lâm TP.HCM",
      "type": "tổ chức"
...
{{
  "entities": [
    ...
    {{
      "entity": "Hoạt động chính",
      "type": "hoạt động"
    }}
  ],
  "relations":[
    {{
      "source" : "CLB Nông Lâm Radio",
      "target" : "Đại học Nông Lâm TP.HCM",
      "relation" : "tại"
    }},
    {{
      "source" : "Đại học Nông Lâm TP.HCM",
      "target" : "Hoạt động chính",
      "relation" : "có"
    }}
  ]
}}
...
"retriever": "<chỉ trả lời 'graph' hoặc 'text'. Không quá 2 từ>"
Lưu ý:
1. Đối với mỗi quan hệ, source hiện tại sẽ lấy target của đối tượng liền kề trước nó
2. soucce và target kKhông được ghi chuỗi theo kiểu lồng chuỗi. Ví dụ như "target": "tiêu chí “học tập tốt”" sẽ chuyển thành "target": "tiêu chí học tập tốt".
}}."""
...
### Nguồn truy xuất hiện tại {action}
### Tài liệu khả thi: {references}

Hãy phản hồi sửa lỗi:
Nếu nguồn truy xuất hiện tại là 'text'
...
- Đề xuất chuyển sang nguồn truy xuất 'graph'

Nếu nguồn truy xuất hiện tại là 'graph'
- Nếu tài liệu không có ý nghĩa. Hãy dự đoán lại mục lục(Ưu tiên).
- Đề xuất chuyển sang nguồn truy xuất 'text'
...
def predict_question_belong_to():
    ...
    RETURN r AS relation, [first, e] AS target
    Câu hỏi về "nội dung vi phạm và khung xử lý kỷ luật sinh viên":
    MATCH (first:part {{name: 'phần 2: học tập và rèn luyện'}})-[:bao_gồm]->(second:section {{name: 'quy định khen thưởng, kỷ luật sinh viên'}})-[:bao_gồm]->(third:part {{name: 'chương 3: kỷ luật'}})-[:bao_gồm]->(fourth:article {{name: 'một số nội dung vi phạm và khung xử lý kỷ luật sinh viên'}})-[r*1..3]->(e)
    RETURN r AS relation, [first, e] AS target
"""
